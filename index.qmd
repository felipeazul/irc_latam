...
::: callout-irc
[📢]{.big-number} In **FY24**, the IRC reached an estimated [366,300]{.big-number} clients across **Latin America**.
:::
...
```{r}
#| label: chart_distributions_render
#| echo: false
#| message: false
#| warning: false
